...
def draw_filter_rules():
    ...
    header_cols[2].markdown("**Operador** <span title='Utilize os operadores de comparação ">", "<", "≥", "≤", "=", "Não é igual a" para definir o primeiro filtro.'>&#9432;</span>", unsafe_allow_html=True)
    header_cols[3].markdown("**Valor** <span title='Insira o valor que deseja excluir dos dados.'>&#9432;</span>", unsafe_allow_html=True)
    header_cols[5].markdown("**Lógica Composta** <span title='Selecione mais um operador para definir um intervalo no critério de exclusão. Caso deseja excluir valores dentro de um intervalo (ex: entre 10 e 20, pode-se utilizar somente o operador  "ENTRE". Caso deseja manter valores dentro de um intervalo, e excluir o que está fora, utilize os operadores "<" ou "≤" para o menor valor, o operador "OU" na lógica composta e os operadores ">" ou "≥" para o maior valor'>&#9432;</span>", unsafe_allow_html=True)
